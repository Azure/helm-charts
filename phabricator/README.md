...
```console
$ helm install azure/phabricator
```
...
To install the chart with the release name `my-release` in the namespace phabricator:

```console
$ helm install --name my-release --namespace phabricator stable/phabricator
```
...
```console
$ helm install --name my-release -f values.yaml azure/phabricator
```
