...
This chart has been adapted from 
[the stable charts repo](https://github.com/kubernetes/charts/tree/master/stable/wordpress) to work
with [service-catalog](../service-catalog) and the 
[Azure service broker](../meta-azure-service-broker-classic).
